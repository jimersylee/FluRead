...
import 'package:flu-read/goods/models/goods_size_model.dart';
import 'package:flu-read/goods/widgets/goods_size_dialog.dart';
...
import 'package:flu-read/widgets/popup_window.dart';
                          ...
                          children: <Widget>[
                            ...
                            Opacity(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                child: Text(
                                  '常读${goodsSizeList[index].currencyPrice}元',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: Dimens.font_sp10
                                  ),
